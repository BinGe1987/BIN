package com.kwaijian.facility.EventCenter;
...
public class EventBus extends HTObject {
    ...
    public void registerEvent(final EventHandler handler, final EventFilter event) {
        mThreadHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                log("事件注册：<" + handler + ">, 当前数量：" + mEventMap.size());
            }
        });
    ...
    public void unRegisterEvent(final EventHandler handler) {
        mThreadHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                log("事件反注册：<" + handler + ">, 当前数量：" + mEventMap.size());
            }
        });
    }
