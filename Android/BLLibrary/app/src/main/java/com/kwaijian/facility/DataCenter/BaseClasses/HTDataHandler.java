...
public abstract class HTDataHandler<T extends HTData> {
     ...
     * @return
     */
    public HTOperationPerformer getOperationPerformer(String operation) {
     ...
     * @return
     */
    public boolean bindOperation(String operation, HTOperationPerformer handler) {
     ...
     * @return
     */
    public boolean bindDataParser(String operation, HTDataParser parser) {
     ...
     * @param data
     */
    public final HTData parseData(String operation, HTData data) {
        HTDataParser parser = operationParser.get(operation);
