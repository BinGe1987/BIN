package com.kwaijian.facility.Utils.UI;
...
public class ActivityUtils {
    ...
    public static boolean setDarkStatusIcon(Activity a, boolean isFontColorDark) {
        if (setStatusBarLightModeWithMIUI(a, isFontColorDark)) {
            return true;
        } else if (setStatusBarLightModeWithFlyme(a, isFontColorDark)) {
            return true;
        } else if (setStatusBarLightModeWithAndroidM(a, isFontColorDark)) {
            return true;
        }
        return false;
    }
    ...
    public static void pushActivityForResult(Context context, Class<?> activityClass, int requestCode) {
        pushActivityForResult(context, new Intent(context, activityClass),requestCode);
    }

    public static void pushActivityForResult(Context context, Intent intent, int requestCode) {
